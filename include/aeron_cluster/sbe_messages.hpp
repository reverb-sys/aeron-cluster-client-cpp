...
struct SessionConnectRequest {
    ...
    static constexpr uint16_t sbeBlockLength() { return 16; }
    static constexpr uint16_t sbeTemplateId() { return 3; }
    static constexpr uint16_t sbeSchemaId() { return 111; }
    static constexpr uint16_t sbeSchemaVersion() { return 8; }
} __attribute__((packed));
...
struct SessionEvent {
    ...
    static constexpr uint16_t sbeBlockLength() { return 32; }
    static constexpr uint16_t sbeTemplateId() { return 2; }
    static constexpr uint16_t sbeSchemaId() { return 111; }
    static constexpr uint16_t sbeSchemaVersion() { return 8; }
} __attribute__((packed));
...
struct TopicMessage {
    ...
    static constexpr uint16_t sbeBlockLength() { return 48; }
    static constexpr uint16_t sbeTemplateId() { return 1; }
    static constexpr uint16_t sbeSchemaId() { return 1; }
    static constexpr uint16_t sbeSchemaVersion() { return 1; }
} __attribute__((packed));
...
struct Acknowledgment {
    ...
    static constexpr uint16_t sbeBlockLength() { return 8; }
    static constexpr uint16_t sbeTemplateId() { return 2; }
    static constexpr uint16_t sbeSchemaId() { return 1; }
    static constexpr uint16_t sbeSchemaVersion() { return 1; }
} __attribute__((packed));
...
public:
     ...
     */
    static std::vector<uint8_t> encodeSessionConnectRequest(
...
private:
     ...
     */
    static size_t encodeVariableString(const std::string& str, 
...
public:
     ...
     */
    static bool decodeMessageHeader(const uint8_t* data, 
                                   size_t length, 
     ...
     */
    static bool decodeSessionEvent(const uint8_t* data, 
                                  size_t length, 
                                  SessionEvent& event,
                                  std::string& detail);
     ...
     * @return true if successfully decoded, false otherwise
     */
    static bool decodeTopicMessage(const uint8_t* data,
                                  size_t length,
                                  std::string& topic,
     ...
     * @return true if successfully decoded, false otherwise
     */
    static bool decodeAcknowledgment(const uint8_t* data,
                                    size_t length,
     ...
     */
    static size_t extractVariableString(const uint8_t* data,
                                       size_t offset,
...
public:
     ...
     * @return ParseResult with all extracted information
     */
    static ParseResult parseMessageDebug(const uint8_t* data, 
                                        size_t length,
     ...
     */
    static bool isAcknowledgmentFor(const uint8_t* data, 
                                   size_t length, 
