...
#ifndef _SBE_ORDERNOTIFICATIONLITE_CXX_H_
#define _SBE_ORDERNOTIFICATIONLITE_CXX_H_
...
public:
    ...
    OrderNotificationLite() = default;

    OrderNotificationLite(
        char *buffer,
    ...
    OrderNotificationLite(char *buffer, const std::uint64_t bufferLength) :
        OrderNotificationLite(buffer, 0, bufferLength, sbeBlockLength(), sbeSchemaVersion())
    {
    }
    ...
    OrderNotificationLite(
        ...
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion) :
        OrderNotificationLite(buffer, 0, bufferLength, actingBlockLength, actingVersion)
    {
    }
    ...
    OrderNotificationLite &wrapForEncode(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
        m_buffer = buffer;
        m_bufferLength = bufferLength;
        m_offset = offset;
    ...
    OrderNotificationLite &wrapAndApplyHeader(char *buffer, const std::uint64_t offset, const std::uint64_t bufferLength)
    {
    ...
    OrderNotificationLite &wrapForDecode(
        char *buffer,
        const std::uint64_t offset,
        const std::uint64_t actingBlockLength,
        const std::uint64_t actingVersion,
    ...
    OrderNotificationLite &sbeRewind()
    {
    ...
    {
        OrderNotificationLite skipper(m_buffer, m_offset, m_bufferLength, m_actingBlockLength, m_actingVersion);
        skipper.skip();
    ...
    OrderNotificationLite &topicId(const std::uint32_t value) SBE_NOEXCEPT
    {
    ...
    OrderNotificationLite &sequence(const std::uint64_t value) SBE_NOEXCEPT
    {
    ...
    OrderNotificationLite &putUuid(const char *src, const std::uint16_t length)
    {
        std::uint64_t lengthOfLengthField = 2;
        std::uint64_t lengthPosition = sbePosition();
    ...
    OrderNotificationLite &putUuid(const std::string &str)
    {
        if (str.length() > 65534)
        {
    ...
    #if __cplusplus >= 201703L
    OrderNotificationLite &putUuid(const std::string_view str)
    {
        if (str.length() > 65534)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    OrderNotificationLite &putMessageIdentifier(const char *src, const std::uint16_t length)
    {
        std::uint64_t lengthOfLengthField = 2;
        std::uint64_t lengthPosition = sbePosition();
        std::uint16_t lengthFieldValue = SBE_LITTLE_ENDIAN_ENCODE_16(length);
    ...
    OrderNotificationLite &putMessageIdentifier(const std::string &str)
    {
        if (str.length() > 65534)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    OrderNotificationLite &putMessageIdentifier(const std::string_view str)
    {
        if (str.length() > 65534)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    OrderNotificationLite &putPayload(const char *src, const std::uint16_t length)
    {
        std::uint64_t lengthOfLengthField = 2;
        std::uint64_t lengthPosition = sbePosition();
        std::uint16_t lengthFieldValue = SBE_LITTLE_ENDIAN_ENCODE_16(length);
    ...
    OrderNotificationLite &putPayload(const std::string &str)
    {
        if (str.length() > 65534)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
    ...
    #if __cplusplus >= 201703L
    OrderNotificationLite &putPayload(const std::string_view str)
    {
        if (str.length() > 65534)
        {
            throw std::runtime_error("std::string too long for length type [E109]");
...
friend std::basic_ostream<CharT, Traits> & operator << (
    std::basic_ostream<CharT, Traits> &builder, const OrderNotificationLite &_writer)
{
    OrderNotificationLite writer(
        _writer.m_buffer,
        _writer.m_offset,
    ...
    builder << '{';
    builder << R"("Name": "OrderNotificationLite", )";
